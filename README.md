...
每次新增、例行更新或發布前，都必須確認店家／場館仍在營運：優先查看官方網站、官方社群或官方訂位頁的近期資訊，再以 Google Maps 的「永久停業」狀態交叉核對。若官方公告、Google Maps 或可信賴的近期來源明確標示為歇業、永久停業或閉館，請從所有 seed、捷運清單與相關對照表一併移除；來源互相矛盾時先不要刪除，改以官方資訊為準並記錄待複查。
